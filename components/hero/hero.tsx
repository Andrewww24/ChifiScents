...
export function Hero() {
  const titleWords = 'Chifri Scents'.split(' ');
  const subtitle = 'Descubre tu fragancia perfecta.';
  ...
  return (
    <section id="inicio" className="relative h-svh">
      {/* Text overlay */}
      <div className="h-svh uppercase items-center w-full absolute z-[60] pointer-events-none px-10 flex justify-center flex-col">
        ...
        <div className="text-xs md:text-xl xl:text-2xl 2xl:text-3xl mt-2 overflow-hidden text-white/80 font-light tracking-widest normal-case">
          <div
